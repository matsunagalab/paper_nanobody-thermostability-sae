...
def train_SAE_on_PLM_embeds(
    ...
    save_logs_to_file: str = "True",  # "True" or "False"
):
    """
    ...
    # Convert string to boolean for save_logs_to_file
    save_logs_to_file_bool = save_logs_to_file.lower() == "true"
    ...
    train_run(
        ...
        # Local logging configuration
        save_logs_to_file=save_logs_to_file_bool,
